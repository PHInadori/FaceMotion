...
namespace FaceMotion.Editor.UI.Localization
{
    ...
    public static class FaceMotionUiText
    {
        private static readonly Dictionary<string, string> Japanese = new Dictionary<string, string>
        {
            ...
            { "preview", "プレビュー" }, { "previewIsolation", "プレビューは分離されています。明示的にシーン適用するまでアバターは変更されません。" }, { "selectAvatarToPreview", "選択中のアニメーションをプレビューするにはアバターを選択してください。" }, { "rebuildPreview", "プレビューを再構築" }, { "startPreview", "プレビューを開始" }, { "stopPreview", "プレビューを停止" }, { "previewPlay", "▶ 再生" }, { "previewPause", "⏸ 一時停止" }, { "previewStop", "■ 停止" }, { "stopSceneApply", "シーン適用を停止" }, { "applyToScene", "シーンに適用" }, { "fitAvatar", "アバターに合わせる" }, { "resetView", "ビューをリセット" }, { "previewControls", "Alt+左ドラッグ: 回転  中ドラッグ: 移動  ホイール: 拡大/縮小  F: アバターに合わせる" }, { "previewNoRenderers", "プレビューアバターにレンダラーがないため、ルートトランスフォームを表示します。" }, { "missing", "不足" }, { "empty", "空" }, { "fps", "fps" }, { "openWindowMenu", "FaceMotion ウィンドウを開く" },
            ...
            { "successBackendLabel", "統合方式" }, { "successAnimationLabel", "アニメーション" }, { "batchIntegration", "一括VRChat追加" }, { "batchCheckedCount", "チェック済み" }, { "batchAddToVrchat", "選択したアニメーションをVRChatへ追加" }, { "tooltipBatchAddToVrchat", "チェックした複数のアニメーションをまとめてエクスポートし、VRChatへ統合します" }, { "batchSelectAnimations", "一括統合するアニメーションをチェックしてください。" }, { "batchSelectAll", "すべてチェック" }, { "batchClearAll", "すべて解除" }, { "batchResultSucceeded", "Batch Integration 完了" }, { "batchResultFailed", "一括統合を停止しました" }, { "animationName", "アニメーション名" }, { "tooltipAnimationName", "VRChat上のメニューにもこの名前が表示されます。" }
        };
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            { "successBackendLabel", "Integration" }, { "successAnimationLabel", "Animation" }, { "batchIntegration", "Batch VRChat Integration" }, { "batchCheckedCount", "Checked" }, { "batchAddToVrchat", "Add Checked Animations to VRChat" }, { "tooltipBatchAddToVrchat", "Export the checked animations together and integrate them into VRChat." }, { "batchSelectAnimations", "Check one or more animations to integrate as a batch." }, { "batchSelectAll", "Check All" }, { "batchClearAll", "Clear All" }, { "batchResultSucceeded", "Batch Integration Complete" }, { "batchResultFailed", "Batch Integration Stopped" }, { "animationName", "Animation Name" }, { "tooltipAnimationName", "This name is also used for the VRChat menu entry." }
        };
