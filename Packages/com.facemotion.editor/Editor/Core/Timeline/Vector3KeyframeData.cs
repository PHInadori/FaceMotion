...
{
    /// <summary>
    /// One transform key. For rotation tracks, Value holds Euler angles that are stored
    /// as authored and never normalized. Interpolation applies to the segment leaving this
    /// key toward the next key; the final key's interpolation is not used by evaluation.
    /// </summary>
    [Serializable]
    public sealed class Vector3KeyframeData
    {
        ...
        public static Vector3KeyframeData Create(
            ...
            KeyOrigin origin)
        {
            var key = new Vector3KeyframeData
            {
                _keyId = StableId.New(),
                _time = time,
                _value = value,
        ...
        public Vector3KeyframeData Clone()
        {
            var clone = new Vector3KeyframeData
            {
                _keyId = _keyId,
                _time = _time,
                _value = _value,
        ...
        /// </summary>
        public Vector3KeyframeData Duplicate()
        {
