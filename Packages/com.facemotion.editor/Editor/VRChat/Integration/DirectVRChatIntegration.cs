    ...
    public static class DirectVRChatIntegration
    {
        ...
        public static DirectIntegrationResult Apply(DirectIntegrationPlan plan)
        {
            ...
            try
            {
                ...
                AddMenuControl(subMenu, null, plan.ParameterName); AddMenuControl(menu, subMenu);
        ...
        private static void AddMenuControl(VRCExpressionsMenu menu, VRCExpressionsMenu submenu, string parameter = null) { var controls = menu.controls ?? new List<VRCExpressionsMenu.Control>(); controls.Add(new VRCExpressionsMenu.Control { name = submenu == null ? "Play" : "FaceMotion", type = submenu == null ? VRCExpressionsMenu.Control.ControlType.Toggle : VRCExpressionsMenu.Control.ControlType.SubMenu, subMenu = submenu, parameter = new VRCExpressionsMenu.Control.Parameter { name = parameter }, value = 1f }); menu.controls = controls; EditorUtility.SetDirty(menu); }
