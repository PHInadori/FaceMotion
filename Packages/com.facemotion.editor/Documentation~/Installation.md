...
VCC / ALCOM に `https://phinadori.github.io/PHInadori-VPM/index.json` を custom VPM repository として追加し、`FaceMotion` `0.1.0` を導入します。listing identity は `PHInadori-VPM` / `com.phinadori.vpm` です。
