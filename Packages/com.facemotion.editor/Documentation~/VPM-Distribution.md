...
and how VCC / ALCOM add the repository. FaceMotion `0.1.2` is published through
...
- Naming is consistent: `com.facemotion.editor-<version>.zip` (for example
  `com.facemotion.editor-0.1.2.zip`).
...
The workflow uploaded the `v0.1.2` release artifact and metadata for the published release.
    ...
    "com.facemotion.editor": {
      "versions": {
        "0.1.2": {
          ...
          "url": "https://github.com/PHInadori/FaceMotion/releases/download/v0.1.2/com.facemotion.editor-0.1.2.zip",
